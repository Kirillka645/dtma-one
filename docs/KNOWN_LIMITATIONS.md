...
- **Full bypass / WARP (0.2.8+):** generates free Cloudflare WARP WireGuard profile for import into official WireGuard app (or open 1.1.1.1 app). Egress is Cloudflare, not DTMA. Disable DTMA while WARP is on.
